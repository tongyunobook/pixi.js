...
var Resource = function () {
  ...
  Resource.prototype.makeMd5 = function (str) {
  ...
  Resource.prototype.yhencrypt = function (str, key) {
    ...
    var i = 0;
    for (i = 0; i < step; i++) {
      asc.push(key.charCodeAt(i));
    }
    var index = 0;
    var result = "";
    while (index < str.length) {
      var tmp = str.slice(index, index + step);
      for (i = 0; i < tmp.length; i++) {
        var enc;
        enc = tmp.charCodeAt(i) ^ asc[i];
  ...
  Resource.prototype.yhencryptBuffer = function (str, key) {
    ...
    for (i = 0; i < str.length; i++) {
      var cell = str[i];
      var index = i % step;
      str[i] = cell ^ asc[index];
    }
    return str;

  }
  Resource.prototype.base64 = function (input) {
